...
export const SYMPOSIUM_CONFIG = {
  ...
  whatsappGroupLink: 'https://chat.whatsapp.com/BCVKMFre7kuIQ4Kj4AXD5L?mode=gi_t',
...
export const TECHNICAL_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    shortDescription: 'A two-round AI challenge focused on image recreation, prompt engineering, and AI video generation.',
    rounds: 'Conducted in 2 rounds',
...
export const NON_TECHNICAL_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    rounds: 'Conducted in 2 level rounds',
    teamSize: 'Team participation (2 to 3 members)',
    time: '2:45 PM to 3:30 PM',
    venue: 'Lab 3',
    organiser: { name: 'Hariharan N', phone: '63693 21573' },
    guidelines: [
      'Conducted in 2 level rounds.',
      'Team participation only (2 to 3 members per team, no individual participation).',
