...
export interface FinanceRecord {
  ...
  section: '2nd CSE A' | '2nd CSE B' | '3rd CSE A' | '3rd CSE B' | '4th CSE A' | '4th CSE B' | 'Final CSE';
  department: string;
  feeAmount: number;
  paidAmount: number;
  status: 'PAID' | 'UNPAID';
...
export const HANDWRITTEN_ONSPOT_SAMPLES: RegistrationData[] = [
  ...
  {
    id: 'ONSPOT-904718',
    fullName: 'Sarumathi. V',
    collegeName: 'ANJALAI AMMAL MAHALINGAM ENGINEERING COLLEGE',
    department: 'IT',
    year: 'III Year',
    email: 'sarusarumathi64@gmail.com',
    mobile: '9047188546',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'PROMPT FUSION',
    nonTechnicalEvent: 'CONNECTION',
    transactionId: 'ONSPOT-CASH',
    ...
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    id: 'ONSPOT-836967-1',
    fullName: 'R. Yalini',
    ...
    department: 'IT',
    year: 'III Year',
    email: 'yaliniravtsundar@gmail.com',
    mobile: '8369676595',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'TECH BRAINIAC',
    nonTechnicalEvent: 'BRAND SPOT',
    transactionId: 'ONSPOT-CASH',
    paymentName: 'On-Spot Desk',
    paymentProofUrl: '',
    paymentProofPath: '',
  ...
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:01:30.000Z',
    verifiedAt: '2026-09-25T09:01:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    verifiedAt: '2026-09-25T09:02:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  ...
  {
    id: 'ONSPOT-735889-1',
    fullName: 'R. B. Raagulraj',
    collegeName: 'ANNA UNIVERSITY ARIYALUR',
    department: 'CSE',
    year: 'II Year',
    email: 'rbaskaraj@gmail.com',
    mobile: '7358897490',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'TECHVERSE',
    nonTechnicalEvent: '',
    transactionId: 'ONSPOT-GPAY',
    paymentName: 'On-Spot Desk',
    paymentProofUrl: '',
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:03:00.000Z',
    verifiedAt: '2026-09-25T09:03:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    id: 'ONSPOT-735889-2',
    fullName: 'R. B. Akashya',
    collegeName: 'ANNA UNIVERSITY ARIYALUR',
    department: 'CSE',
    year: 'IV Year',
    email: 'rbaskaraj@gmail.com',
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:03:30.000Z',
    verifiedAt: '2026-09-25T09:03:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:04:00.000Z',
    verifiedAt: '2026-09-25T09:04:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:04:30.000Z',
    verifiedAt: '2026-09-25T09:04:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    verifiedAt: '2026-09-25T09:05:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  ...
  {
    id: 'ONSPOT-638202-1',
    fullName: 'R. Subhalakshmi',
    collegeName: 'ANJALAI AMMAL MAHALINGAM ENGINEERING COLLEGE',
    department: 'CSE',
    year: 'II Year',
    email: 'Subaram718@gmail.com',
    mobile: '6382025909',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'TECHVERSE',
    ...
    verifiedAt: '2026-09-25T09:10:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:10:30.000Z',
    verifiedAt: '2026-09-25T09:10:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  ...
  {
    id: 'ONSPOT-994404-1',
    fullName: 'S. K. Shankarasree',
    collegeName: 'ANJALAI AMMAL MAHALINGAM ENGINEERING COLLEGE',
    department: 'CSE',
    year: 'II Year',
    email: 'tharikasreesk@gmail.com',
    mobile: '9944049567',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'TECHVERSE',
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:11:00.000Z',
    verifiedAt: '2026-09-25T09:11:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  ...
  // Sheet 3
  {
    ...
    verifiedAt: '2026-09-25T09:15:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:15:30.000Z',
    verifiedAt: '2026-09-25T09:15:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    department: 'CSE',
    year: 'II Year',
    email: 'dharshini.AJDS15@gmail.com',
    mobile: '8680915388',
    ambassadorReferralId: '',
    foodPreference: 'Veg',
    technicalEvent: '',
    ...
    verifiedAt: '2026-09-25T09:16:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:16:30.000Z',
    verifiedAt: '2026-09-25T09:16:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    department: 'CSE',
    year: 'III Year',
    email: 'Ashifashirin987@gmail.com',
    mobile: '9042710569',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'TECH BRAINIAC',
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:17:00.000Z',
    verifiedAt: '2026-09-25T09:17:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:17:30.000Z',
    verifiedAt: '2026-09-25T09:17:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    verifiedAt: '2026-09-25T09:18:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    department: 'CSE',
    year: 'IV Year',
    email: 'Snaveen1234PM@gmail.com',
    mobile: '9042845757',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'BUG BASH',
    nonTechnicalEvent: 'BRAND SPOT',
    transactionId: 'ONSPOT-GPAY',
    paymentName: 'On-Spot Desk',
    paymentProofUrl: '',
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:19:00.000Z',
    verifiedAt: '2026-09-25T09:19:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:19:30.000Z',
    verifiedAt: '2026-09-25T09:19:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  ...
  {
    id: 'ONSPOT-842814-1',
    fullName: 'Swathisri. P',
    collegeName: 'SHRIMATI INDIRA GANDHI COLLEGE',
    department: 'CSE',
    year: 'I Year',
    email: 'mathivanan.darshini35@gmail.com',
    mobile: '8428145954',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'PROMPT FUSION',
    ...
    verifiedAt: '2026-09-25T09:20:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'CASH',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:20:30.000Z',
    verifiedAt: '2026-09-25T09:20:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    id: 'ONSPOT-638577-1',
    fullName: 'R. Subitsha',
    collegeName: 'A.R.J. COLLEGE OF ENGINEERING AND TECHNOLOGY',
    department: 'CSE',
    year: 'II Year',
    email: 'subitsharamaakrishnan@gmail.com',
    mobile: '6385773684',
    ambassadorReferralId: '',
    foodPreference: 'Non-Veg',
    technicalEvent: 'BUG BASH',
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:25:00.000Z',
    verifiedAt: '2026-09-25T09:25:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:25:30.000Z',
    verifiedAt: '2026-09-25T09:25:30.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
  },
  {
    ...
    paymentProofPath: '',
    status: 'VERIFIED',
    createdAt: '2026-09-25T09:26:00.000Z',
    verifiedAt: '2026-09-25T09:26:00.000Z',
    verifiedBy: 'On-Spot Desk',
    isOnSpot: true,
    amountPaid: 200,
    onSpotPaymentMode: 'GPAY',
...
const INITIAL_IV_CSE_A: Array<{ roll: string; name: string }> = [
  { roll: '23CSA01', name: 'ABINESH A' },
  { roll: '23CSA02', name: 'ABIRAMI M' },
  { roll: '23CSA03', name: 'ABIRAMI N' },
  { roll: '23CSA04', name: 'ABIRAMI P' },
  { roll: '23CSA05', name: 'ABISHAK W' },
  { roll: '23CSA06', name: 'ADHIGA M' },
  { roll: '23CSA07', name: 'ADHITYA G' },
  { roll: '23CSA08', name: 'AJAY V' },
  { roll: '23CSA09', name: 'AKASH G' },
  { roll: '23CSA10', name: 'AKASH K (11.03.2006)' },
  { roll: '23CSA11', name: 'AKASH K (25.09.2006)' },
  { roll: '23CSA12', name: 'AKASH R' },
  { roll: '23CSA13', name: 'AMARNATH T' },
  { roll: '23CSA14', name: 'ANJEL T' },
  { roll: '23CSA15', name: 'ARAVINTH R' },
  { roll: '23CSA16', name: 'ATCHAYASRI D' },
  { roll: '23CSA17', name: 'BHARANITHARAN R' },
  { roll: '23CSA18', name: 'CHANDRA MUKILAN V' },
  { roll: '23CSA19', name: 'DAKSHNA R' },
  { roll: '23CSA20', name: 'DEERGATHARSAN A V' },
  { roll: '23CSA21', name: 'DHARUN M' },
  { roll: '23CSA22', name: 'DHINESHKARTHIK P' },
  { roll: '23CSA23', name: 'DIVYA G' },
  { roll: '23CSA24', name: 'GUNANATHAN G S' },
  { roll: '23CSA25', name: 'GURUDEV N' },
  { roll: '23CSA26', name: 'HAMSAVARTHINI M' },
  { roll: '23CSA27', name: 'HARIHARAN M' },
  { roll: '23CSA28', name: 'HARIHARAN N' },
  { roll: '23CSA29', name: 'HARIBARAPERUMAL R S' },
  { roll: '23CSA30', name: 'HARINI E' },
  { roll: '23CSA31', name: 'INBAN E' },
  { roll: '23CSA32', name: 'INDHUPRIYAN S' },
  { roll: '23CSA33', name: 'JAGADESHWARAN T' },
  { roll: '23CSA34', name: 'JAYA PRAKASH J' },
  { roll: '23CSA35', name: 'JEEVAJOTHI P' },
  { roll: '23CSA36', name: 'JERRYN JEFFERSON P' },
  { roll: '23CSA37', name: 'KABILAN P' },
  { roll: '23CSA38', name: 'KALANITHI U' },
  { roll: '23CSA39', name: 'KARAN K' },
  { roll: '23CSA40', name: 'KARISHMA R' },
  { roll: '23CSA41', name: 'KARTHIKEYAN S' },
  { roll: '23CSA42', name: 'KAVITHA S' },
  { roll: '23CSA43', name: 'LAKSHMI PRIYA M' },
  { roll: '23CSA44', name: 'LAVANYA K' },
  { roll: '23CSA45', name: 'LOGESH R' },
  { roll: '23CSA46', name: 'MAHESWARAN M' },
  { roll: '23CSA47', name: 'MANIMARAN M' },
  { roll: '23CSA48', name: 'MELVINANTO A' },
  { roll: '23CSA49', name: 'MERUDULA S' },
  { roll: '23CSA50', name: 'MOHAMED ABDUL RAHIM S' },
  { roll: '23CSA51', name: 'MOHAMED FURZEES M' },
  { roll: '23CSA52', name: 'MOHANDOSS R' },
  { roll: '23CSA53', name: 'MONIKA P' },
  { roll: '23CSA54', name: 'MUBASHIR M' },
  { roll: '23CSA55', name: 'NARMADHA G' },
  { roll: '23CSA56', name: 'NAVIN KUMAR G' },
  { roll: '23CSA57', name: 'NITHISHKUMAR S' },
  { roll: '23CSA58', name: 'MOHAMED RIZWAN S' },
  { roll: '23CSA59', name: 'GUHAN S' },
];
...
const INITIAL_IV_CSE_B: Array<{ roll: string; name: string }> = [
  ...
  { roll: '23CSB40', name: 'THENNARASI K' },
  { roll: '23CSB41', name: 'THILAGANRAM M' },
  { roll: '23CSB42', name: 'THIYANESWARAN V' },
  { roll: '23CSB43', name: 'VAISHNAVI P' },
  { roll: '23CSB44', name: 'VENKADESAKUMAR S' },
  { roll: '23CSB45', name: 'VENKATESHWARAN G' },
  { roll: '23CSB46', name: 'VERNICA S' },
  { roll: '23CSB47', name: 'VIGARTHAN M' },
  { roll: '23CSB48', name: 'VIGNESH C' },
  { roll: '23CSB49', name: 'VIGNESHWARI R' },
  { roll: '23CSB50', name: 'VIJAY KUMAR K' },
  { roll: '23CSB51', name: 'VINITH KUMAR S' },
  { roll: '23CSB52', name: 'VISHNU S' },
  { roll: '23CSB53', name: 'VISHNUVARTHAN K' },
  { roll: '23CSB54', name: 'VISVANANTHINI N' },
  { roll: '23CSB55', name: 'YALINI SRIMATHI S' },
  { roll: '23CSB56', name: 'YASMIN BANU M' },
  { roll: '23CSB57', name: 'YAZHINI A' },
  { roll: '23CSB58', name: 'YAZHINI S' },
  { roll: '23CSB59', name: 'KANNA N' },
];
