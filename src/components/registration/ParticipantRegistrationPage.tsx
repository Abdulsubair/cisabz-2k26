    ...
    return (
      <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 flex items-center justify-center bg-slate-950/95 text-slate-100 backdrop-blur-2xl">
        <div className="max-w-xl w-full bg-slate-900 border border-emerald-500/50 rounded-3xl p-6 sm:p-10 shadow-[0_0_50px_rgba(16,185,129,0.3)] text-center relative overflow-hidden my-8 animate-in fade-in zoom-in duration-300">
          ...
          {/* WHATSAPP GROUP JOIN CARD FOR REGISTRATION SUCCESS */}
          <div className="bg-emerald-950/50 border border-emerald-500/40 rounded-2xl p-5 mb-6 text-left relative overflow-hidden shadow-[0_0_30px_rgba(16,185,129,0.2)] group">
            <div className="flex items-center gap-3.5 mb-2">
              <div className="p-3 rounded-xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 shrink-0 group-hover:scale-110 transition-transform">
            ...
            <a
              ...
              className="w-full py-3 px-4 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold font-orbitron text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.4)] transition-all cursor-pointer mt-3"
            >
